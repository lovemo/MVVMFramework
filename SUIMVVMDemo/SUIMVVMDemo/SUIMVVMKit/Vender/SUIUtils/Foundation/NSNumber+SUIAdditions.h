...
@interface NSNumber (SUIAdditions)
...
@property (readonly,copy) NSDate *sui_toDate;

@property (readonly,copy) NSString *sui_toString;
...
@property (readonly) CGFloat sui_CGFloatValue;
...
@property (readonly,copy) NSString *sui_toRomanNumeral;
