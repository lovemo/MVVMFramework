...
- (void)sui_cellWillDisplayWithModel:(id)cModel
{
    ...
    self.lbHeight.text = ((self.sui_indexPath.row) % 2 == 0) ? lengthStr : shortStr;
    self.contentImage.image = ((self.sui_indexPath.row) % 2 == 0) ? [UIImage imageNamed:@"phil"] : [UIImage imageNamed:@"dogebread"];
}
