...
- (void)setupTableView
{
    ...
    self.sui_tableView.separatorStyle = UITableViewCellSelectionStyleNone;
    
    self.sui_tableView.tableHander = [[TestViewDelegate alloc]initWithViewModel:[[BQViewModel alloc]init]
